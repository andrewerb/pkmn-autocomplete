...
def setup_trie():
    ...
    This function is primarily for readability, because of the large text block for the list of names.
    """
    pkmn_trie = Trie()
...
def main():
    ...
    * traverse threads + backtrack to match.
    """
    print("PKMN Autocomplete Running main.")
